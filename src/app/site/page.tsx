...
export default function Home() {
  return (
    <>
      <section className="h-full w-full mt-[-70px] md:mt-[130px] relative flex items-center justify-center flex-col">
        ...
        <div className="md:mt-[120px] mt-[100px]">
          ...
          <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative">
            <h1 className="text-9xl font-bold text-center md:text-[300px]">JPlura</h1>
          </div>
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-[200px] mt-[-80px]">
            ...
            <Card key={card.title} className={clsx('w-[300px] flex flex-col justify-between', {
              ...
              <CardFooter className="flex flex-col items-start gap-4">
                ...
                <Link href={`/agency?plan=${card.priceId}`} className={clsx(
                  ...
                  {
                    'bg-primary hover:bg-[#172554]': card.title === 'Unlimited Saas',
                    'bg-muted-foreground hover:bg-[#334155]': card.title !== 'Unlimited Saas'
                  }
                )}
                >
                  Get Started
