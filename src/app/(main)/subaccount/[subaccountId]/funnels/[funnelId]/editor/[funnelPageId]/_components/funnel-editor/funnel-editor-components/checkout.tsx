...
const Checkout = (props: Props) => {
  ...
  useEffect(() => {
    ...
    fetchData(); //when the subaccountID from the useEditor comes in, 
  }, [subaccountId]);
  ...
  useEffect(() => {
    if (funnelId) {
      ...
      fetchData(); //get the funnelId from the useEditor
    }
  }, [funnelId]); 

  //when the component renders, it's going to fire when we have live prices, subId, and subaccountConnectAccId.
  useEffect(() => {
