...
const FunnelEditorSidebar = ({ subaccountId }: Props) => {
  ...
  return (
    <Sheet open={true} modal={false}>
      {/* by default just show the Settings tab */}
      <Tabs className="w-full " defaultValue="Settings">
        ...
        >
          {/* another tab that showing the content of specify components */}
          <div className="grid gap-4 h-full pb-36 overflow-auto custom-scrollbar">
