...
export type DeviceTypes = "Desktop" | "Mobile" | "Tablet"; //this is available type for editor to switch.
...
export type EditorElement = {
  ...
  name: string;
  type: EditorBtns;
  content: EditorElement[] | {}; //it will be either editor element and an array of them or it will be a special objects
};
...
//initialState of the entire editor
